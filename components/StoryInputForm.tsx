...
import '../styles/StoryInputForm.css'; // Ensure CSS is imported for deployment
    ...
    <form onSubmit={handleSubmit} className="story-input-form-container">
      <div className="form-group">
        ...
        <p className="input-description">
          Min. 50 characters. Approx. Max. 10,000 words (60,000 characters).
        </p>
      </div>
        ...
        <div className="form-group">
          ...
          <div className="form-select-wrapper">
            <select
              id="era"
              value={era}
              onChange={(e) => setEra(e.target.value as ComicEra)}
              className="form-select"
            >
      ...
      <div className="form-group-grid">
        ...
        <div className="form-group">
          <label htmlFor="numPages" className="form-label">
            Number of Pages (1-{MAX_COMIC_PAGES})
          </label>
          <input
            type="number"
            id="numPages"
            value={numPages}
            onChange={(e) =>
              setNumPages(Math.max(1, Math.min(MAX_COMIC_PAGES, parseInt(e.target.value) || 1)))
            }
            min={1}
            max={MAX_COMIC_PAGES}
      ...
      <div className="form-group-grid">
        <div className="form-group">
          <label htmlFor="textModel" className="form-label">
        ...
        <div className="form-group">
          <label htmlFor="imageModel" className="form-label">
      ...
      <div className="form-group">
        <div className="checkbox-group">
          ...
          />
          <label htmlFor="includeCaptions" className="checkbox-label">
            Include Captions & Dialogues
          </label>
        </div>
        {includeCaptions && (
          <div className="form-group" style={{ marginTop: '0.5rem', marginLeft: '1.5rem' }}>
            <label htmlFor="captionPlacement" className="form-label" style={{ paddingLeft: 0 }}>
              Placement:
            </label>
            <div className="form-select-wrapper">
              <select
                ...
                className="form-select"
              >
                {AVAILABLE_CAPTION_PLACEMENTS.map((cp) => (
            ...
            <p className="input-description" style={{ paddingLeft: 0, fontSize: '0.7rem' }}>
              Note: Embedding in image is experimental and AI may not always render text perfectly.
            </p>
          </div>
        )}
      </div>
